...
namespace TimLearning.Infrastructure.Implementation.Db.Migrations
{
    ...
    [Migration("20240605202658_Add_User_Solution_Code_Review")]
    partial class Add_User_Solution_Code_Review
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimLearning.Domain.Entities.CodeReviewNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CodeReviewNotes");
                });

            modelBuilder.Entity("TimLearning.Domain.Entities.CodeReviewNoteComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("CodeReviewNoteId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CodeReviewNoteId");

                    b.ToTable("CodeReviewNoteComments");
                });
            ...
            modelBuilder.Entity("TimLearning.Domain.Entities.CodeReview", b =>
                {
                    ...
                    b.HasOne("TimLearning.Domain.Entities.UserSolution", "UserSolution")
                        .WithOne("CodeReview")
                        .HasForeignKey("TimLearning.Domain.Entities.CodeReview", "UserSolutionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TimLearning.Domain.Entities.CodeReviewNote", b =>
                {
                    b.HasOne("TimLearning.Domain.Entities.CodeReview", "CodeReview")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("TimLearning.Domain.Entities.CodeReviewNoteComment", b =>
                {
                    b.HasOne("TimLearning.Domain.Entities.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TimLearning.Domain.Entities.CodeReviewNote", "CodeReviewNote")
                        .WithMany("Comments")
                        .HasForeignKey("CodeReviewNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Author");

                    b.Navigation("CodeReviewNote");
                });
